...
export const UPDATE_EMPLOYEE = gql`
    mutation($id: ID!, $name: String!, $joinYear: Int!, $department: ID!) {
        updateEmployee(
            input: { id: $id, name: $name, joinYear: $joinYear, department: $department }
        ) {
            employee {
                id
                name
...
export const PAGINATION_FIRST_EMPLOYEE = gql`
    query($first: Int) {
...
export const PAGINATION_LAST_EMPLOYEE =gql`
    query($last: Int) {
...
export const PAGINATION_MORE_EMPLOYEE = gql`
